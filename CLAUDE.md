...
| Single-feature projects   | `:format-loading`, `:playback`, `:sidebar`, `:licorice`, `:widget-api`, `:widget-examples`, `:pipeline-editor`, `:pipeline-file`, `:render-modal`, `:phase2` | Webapp host unless the project name encodes another                                                                                                                              |
