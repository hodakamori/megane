...
- Parameters: \`{ type: "representation", mode: "atoms" | "cartoon" | "both" | "surface" | "licorice" }\`
  ...
  - "licorice": thick continuous tube — atoms and bonds rendered at the same radius (VMD-style)
- Inputs: \`in\` (particle only — NOT bond)
- Outputs: \`out\` (particle)
