...
export function RenderModal({
  ...
  return createPortal(
    <div style={backdropStyle} onClick={exporting ? undefined : onClose} data-testid="render-modal-backdrop">
      <div style={panelStyle} onClick={(e) => e.stopPropagation()} data-testid="render-modal" data-mode={hasAnimation ? "with-animation" : "snapshot-only"}>
        {/* Header */}
        <div
          style={{
            display: "flex",
