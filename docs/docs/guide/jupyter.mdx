...
<LiveViewer data="caffeine_water" caption="A live megane widget showing caffeine solvated in water — drag to rotate, scroll to zoom. This is the same renderer the notebook cell mounts." />
