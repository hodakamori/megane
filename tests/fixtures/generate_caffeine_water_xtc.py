"""Generate a synthetic XTC trajectory for the caffeine+water demo.
...
PDB_PATH = "tests/fixtures/caffeine_water.pdb"
XTC_PATH = "tests/fixtures/caffeine_water_vibration.xtc"
N_FRAMES = 100
